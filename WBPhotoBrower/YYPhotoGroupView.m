...
- (instancetype)init {
    ...
    _imageView.backgroundColor = [UIColor colorWithWhite:0.000 alpha:0.500];
...
//    [_imageView cancelCurrentImageRequest];
    ...
    if(!item.largeImageURL && item.asset)
    {
        PHImageRequestOptions *uploadOptions = [PHImageRequestOptions new];
        uploadOptions.synchronous = NO;
        uploadOptions.resizeMode   = PHImageRequestOptionsResizeModeExact;
        uploadOptions.deliveryMode = PHImageRequestOptionsDeliveryModeHighQualityFormat;
...
- (instancetype)initWithGroupItems:(NSArray *)groupItems {
    ...
    _pager.currentPageIndicatorTintColor = [UIColor colorWithRed:219 green:32 blue:19 alpha:0];
    _pager.pageIndicatorTintColor = [UIColor whiteColor];
